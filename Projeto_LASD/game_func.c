...
void start_game_config(uint8_t dezena, uint8_t unidade){
	// FunÁ„o que inicializa o jogo, define as configuraÁıes que dever„o ser utilizadas
	
}
void game_running_display_init(){
	// FunÁ„o respons·vel por gerenciar o display nokia durante o funcionamento do jogo
